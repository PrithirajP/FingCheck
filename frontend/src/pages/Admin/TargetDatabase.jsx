        ...
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-6">
          ...
          <div className="space-y-2">
            ...
            <input 
              type="text" 
              value={deviceMeta} 
              onChange={(e) => setDeviceMeta(e.target.value)} 
          ...
          <button 
            ...
            className="w-full bg-amber-600 hover:bg-amber-700 disabled:bg-slate-800 text-white font-medium py-3 rounded-xl transition flex items-center justify-center gap-2"
          >
